...
$(document).ready(function(){
  $("#titleA").click(function(){
    $("#asA").slideToggle("fast");
  });
  $("#asA").slideToggle("fast");
  
  $("#titleB").click(function(){
    $("#asB").slideToggle("fast");
  });
   $("#asB").slideToggle("fast");
  ...
  $("#titleD").click(function(){
    $("#asD").slideToggle("fast");
  });
  $("#asD").slideToggle("fast");
  
  $("#titleE").click(function(){
    $("#asE").slideToggle("fast");
  });
  $("#asE").slideToggle("fast");
  
  $("#titleF").click(function(){
    $("#asF").slideToggle("fast");
  });
  $("#asF").slideToggle("fast");
  
  $("#titleG").click(function(){
    $("#asG").slideToggle("fast");
  });
  $("#asG").slideToggle("fast");
  
  $("#titleH").click(function(){
    $("#asH").slideToggle("fast");
  });
  $("#asH").slideToggle("fast");
  
  $("#titleI").click(function(){
    $("#asI").slideToggle("fast");
  });
  $("#asI").slideToggle("fast");
  
  $("#titleJ").click(function(){
    $("#asJ").slideToggle("fast");
  });
  $("#asJ").slideToggle("fast");
  
  $("#titleK").click(function(){
    $("#asK").slideToggle("fast");
  });
  $("#asK").slideToggle("fast");
  
  $("#titleL").click(function(){
    $("#asL").slideToggle("fast");
  });
  $("#asL").slideToggle("fast");
  
  $("#titleM").click(function(){
    $("#asM").slideToggle("fast");
  });
  $("#asM").slideToggle("fast");
	...
	for(var pp=0;pp<num;pp++){
		resultNum[pp]=$.cookie("resultNum")[2*pp];
	}
	
	if(num==1){
		resultNum[0]=$.cookie("resultNum");
	}
	getAnswer();
